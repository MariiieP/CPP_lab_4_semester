...
//class correct
//{
int correct::input_number(int min, int max, string message)
{
int n;
   do
    {
...
// ввод информации
string correct::input_information(string messge)
{
    string a;
    cout << messge ;
    cin >> a;
...
bool correct::correct_symbol(char c)
{
    switch (c)
    {
        case '.':
...
bool correct::correct_name(string name)
{
...
// ввод имени файла
string correct::input_file_name()
{
    string filename;
    do
    {
